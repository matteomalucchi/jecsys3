...
_gf_label["hdm_mpfchs1_multijet"] = "Multijet"; //"Multijet (HDM)";//(p_{T,HDM}^{avp})";//(p_{T}^{leading})";
...
_gf_label["hdm_mpfchs1_gamjet"] = "#gamma+jet"; //"#gamma+jet (HDM)";
_gf_label["hdm_gamjet"] = "#gamma+jet"; //"#gamma+jet (HDM)";
_gf_label["hdm_mpfchs1_jetz"] = "X";//(_gf_fitZjetHDM ? "Z+jet (HDM)" : "Not fit: Z+jet (HDM)");// (UH)";
_gf_label["hdm_mpfchs1_zjet"] = (_gf_fitZjetHDM ? "Z+jet" : "Not fit: Z+jet"); //(_gf_fitZjetHDM ? "Z+jet (HDM)" : "Not fit: Z+jet (HDM)");// (UH)";
